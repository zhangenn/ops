...
MAX_RESULT = int(os.environ.get('MAX', '9999'))
...
def initial_articles():
    ...
    articles = arxiv.query(search_query, max_results=MAX_RESULT, start=START_INDEX, 
...
def update_articles():
    ...
    new_articles = arxiv.query(search_query, max_results=MAX_RESULT, start=START_INDEX, 
                               sort_by="lastUpdatedDate", sort_order="descending")
    ...
    print(f"Update completed: {counter} updates made.")
